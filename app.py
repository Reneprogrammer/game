...
character = st.radio("Select a character", ('Journalist', 'Humanitarian Worker', 'Local Citizen'))
...
def scenario_1():
    ...
    decision_1 = st.radio("Do you:", ('Interview locals to get their perspective', 'Visit the front lines to report on the conflict'))
...
def scenario_2():import streamlit as st
import random
...
def rpg_game():
    ...
    def scenario_2():
        ...
        decision_2 = st.radio("Do you:", ('Coordinate with local NGOs to distribute aid', 'Set up a medical camp to assist the injured'))
    ...
    def scenario_3():
        ...
        decision_3 = st.radio("Do you:", ('Stay in your home and wait for the conflict to subside', 'Move to a refugee camp for safety'))
...
def main():
    st.title("Learn About the Sudan Conflict")
    st.sidebar.title("Navigation")
    options = st.sidebar.radio("Go to", ["Quiz", "Interactive Story", "Timeline Puzzle", "RPG Game"])
